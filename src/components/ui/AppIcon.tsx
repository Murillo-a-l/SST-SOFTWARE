...
const icons: Record<AppIconProps['name'], JSX.Element> = {
  dashboard: (
  ...
  folder: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 7.5A1.5 1.5 0 014.5 6h3.879a1.5 1.5 0 011.06.44l1.121 1.12a1.5 1.5 0 001.06.44H19.5A1.5 1.5 0 0121 9.5v8A1.5 1.5 0 0119.5 19h-15A1.5 1.5 0 013 17.5v-10z" />
    </svg>
  ),
  document: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.378a2.25 2.25 0 00-.659-1.591L13.72 4.159a2.25 2.25 0 00-1.591-.659H8.25A2.25 2.25 0 006 5.75v12.5A1.75 1.75 0 007.75 20h8.5A1.75 1.75 0 0018 18.25v-2.5z" />
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13.5 3.75V6a2.25 2.25 0 002.25 2.25H18" />
    </svg>
  ),
  check: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
